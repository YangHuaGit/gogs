...
// [0]: issues, [1]: wiki
func C_RepoAssignment(pages ...bool) macaron.Handler {
	return func(c *Context) {
		...
		c.Repo.RepoLink = repo.C_Link(c.Repo.Owner.Name)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		gitRepo, err := git.OpenRepository(models.C_RepoPath(ownerName,c.Params(":directoryId"), repoName))



		fmt.Println(11111111111,(models.C_RepoPath(ownerName,c.Params(":directoryId"), repoName)))
		fmt.Println(22222222222,gitRepo)
...
func C_RepoRef() macaron.Handler {
	return func(c *Context) {
